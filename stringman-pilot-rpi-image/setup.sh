...
echo "Configuring cranebot.service with component type: $IGconf_variables_componenttype"
# Appends the argument to the ExecStart line (e.g. ".../component-server" -> ".../component-server <type>")
sed -i "s|^ExecStart=.*|& $IGconf_variables_componenttype|" "$ROOTFS_DIR/etc/systemd/system/cranebot.service"
