...
# CONFIGURATION
# ==========================================
DEFAULT_REPO_ID = "naavox/angling-dataset"
DEFAULT_MODEL_PATH = "models/angling.pth"
LOCAL_DATASET_ROOT = "angling_data"
...
def label_mode(args):
    ...
    # We work directly within the local angling_data folder
    ...
    cv2.namedWindow("Labeler", cv2.WINDOW_AUTOSIZE)
...
if __name__ == "__main__":
    ...
    label_p.add_argument("--relabel", action="store_true", help="Relabel local angling_data missing angles")
